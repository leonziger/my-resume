...
window.onresize = _nouislider2.default.create(rangeSlider, {
    start: window.innerWidth <= 640 ? 66 : 51,
    range: {
        'min': [0],
        'max': [100]
    },
